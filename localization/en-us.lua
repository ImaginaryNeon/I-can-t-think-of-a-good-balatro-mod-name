    ...
    descriptions = {
        Joker = {
            ...
            j_neonmod_tcfna = {
                ...
                text = {
                    "Gains {X:dark_edition,C:white} ^#2# {} Mult per card with an {C:enhanced}Enhancement{}, {C:edition}Edition{},",
            ...
            j_neonmod_hybrid = {
                ...
                text = {
                    ...
                    "{s:0.7,C:inactive}90% of this rpg is for all ages, though maybe NOT",
                    "{s:0.7,C:inactive,u:inactive}RULE #3# 193{}{s:0.7,C:inactive}which is {s:0.7,u:inactive,C:inactive}NOT{}{s:0.7,C:inactive} meant to be read by kids, and",
                    "{s:0.7,C:inactive,u:inactive}RULE #3# 187{}{s:0.7,C:inactive}EXPLAINS homosexuality mathematically,",
                    "{s:0.7,C:inactive}using modifier G @ 11.",
                },
            },
