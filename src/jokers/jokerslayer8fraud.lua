...
SMODS.Joker {
    ...
    calculate = function(self, card, context)
        ...
        if context.individual and context.cardarea == G.play and G.GAME.current_round.hands_played <= 0 and #context.full_hand == 1 and (context.scoring_hand[1]:get_id() == 2 or context.scoring_hand[1]:get_id() == 8) then
